...
import { fetchPorUbicar } from "@/lib/mapaZonas";
import { getRole } from "@/lib/session";
import { roleCan } from "@/lib/auth";

// Listings of one estado whose location needs a human («Por ubicar» tab).
...
export async function GET(req: Request) {
  ...
  try {
    return NextResponse.json(await fetchPorUbicar(estado), {
